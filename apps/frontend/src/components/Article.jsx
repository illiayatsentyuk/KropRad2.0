...
export const Article = ({ title, description, author, id, handleDelete, handleEditArticle }) => {
    ...
    return (
        <div className="flex justify-between flex-col gap-3 bg-white p-5 sm:p-6 rounded-2xl shadow-md border border-[#E9ECF2] transition-all duration-300 hover:shadow-lg hover:border-[#3F7EF7] hover:-translate-y-0.5">
